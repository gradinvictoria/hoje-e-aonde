...
function photos(slug: string, count = 5): string[] {
...
const places = [
  {
    ...
    description:
      "Cantina italiana descontraída em um quintal ao ar livre na Vila Madalena, com música ao vivo às quintas e sextas, cardápio de massas artesanais e opção pet friendly. Ideal para jantares em grupo ou um encontro casual depois do trabalho.",
  ...
  },
  {
    ...
    category: "Aula",
    description:
      "Aulas de yoga vinyasa para todos os níveis em um estúdio arejado no Itaim. Turmas pequenas, tapetes disponíveis no local e primeira aula gratuita.",
  ...
  },
  {
    ...
    category: "Evento",
    description:
      "Feira mensal de vinil, CDs e memorabília musical no coração do Centro, com food trucks e DJ set ao vivo. Entrada gratuita.",
  ...
  },
  {
    ...
    state: "SP", city: "Atibaia", neighborhood: "Zona Rural",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Santa Cecília",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Interlagos",
  ...
  },
  {
    ...
    state: "SP", city: "Campinas", neighborhood: "Cambuí",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Parque do Ibirapuera",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Lapa",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Perdizes",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Consolação",
  ...
  },
  {
    ...
    state: "SP", city: "São Paulo", neighborhood: "Tatuapé",
